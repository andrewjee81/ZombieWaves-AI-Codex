...
This project follows the modern 'Local LLM Fine-Tuning' pipeline. I am by no means an expert; like many of you, I am learning as I go. If you are new to AI training, I highly recommend the following resources that were instrumental in helping me understand and implement this project. This document tracks the technical foundations and academic research that power the **Zombie Waves AI Codex**.

## 🧠 Core LLM Research
- **[Google Research (March 24, 2026)](https://research.google/blog/turboquant-redefining-ai-efficiency-with-extreme-compression/):** *TurboQuant+: Scaling Inference on Limited VRAM via PolarQuant & QJL.*
  - Key Application: Enabled the 6x KV Cache compression used to audit 226+ Codex entries on 4GB VRAM.

- **[Alibaba Qwen Team (2024-09-18)](https://qwen.ai/blog?id=qwen2.5)**: Qwen 2.5: A Party of Foundation Models.
  - Key Application: Provided the base 3B-Instruct architecture optimized for structured ChatML extraction and complex strategic reasoning within the 4GB VRAM envelope.
...
### 🚀 The Qwen 2.5 "Omni": Native Multimodal Strategy

* **[Alibaba Qwen Team (2025-03-26)](https://www.youtube.com/watch?v=yKcANdkRuNI):** The video introduces Qwen2.5-Omni, a native end-to-end multimodal model capable of real-time voice and video interaction. It demonstrates the model's ability to "see" and reason across live inputs—such as analyzing drawings, summarizing browser content, and solving maths problems—without relying on separate vision or audio encoders.
* **[Qwen2.5 Omni](https://qwen.ai/blog?id=qwen2.5-omni):** See, Hear, Talk, Write, Do It All!


### 🚀 The Qwen 3.5 "Agentic"
...
* **[Video: How to Fine-Tune Llama 3 Locally](https://www.youtube.com/watch?v=pxhkDaKzBaY):** A comprehensive guide on the entire pipeline from data to local deployment.
* **[Video: Discord Data for AI](https://www.youtube.com/watch?v=Oms0D-A88JY)** - Understanding why data cleaning is the most critical step in the process.
...
* **[Video: Scraping YouTube with OpenAI (Eli the Computer Guy)](https://www.youtube.com/watch?v=2TL3DgIMY1g):** Provided the logic for our YouTube Transcript Chunker, converting long-form video audio into structured strategy pairs.
